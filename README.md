...
```bash
aws ec2 describe-images --image-ids ami-0aa87bb13770d5d3d --query 'Images[0].ImageId' --output text
```

**Example output:** `ami-0aa87bb13770d5d3d`

**Where it's used:**
- `mr-bluejays-parent.yml:69` - `BlueJaysAMI: "ami-0aa87bb13770d5d3d"`
...
| AMI ID | `aws ec2 describe-images` (region-specific) | `ami-0aa87bb13770d5d3d` | EC2 instances |
